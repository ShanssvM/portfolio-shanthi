...
<p><i><b>Ready to build something meaningful together?</b></i></p>
          ...
          <div className="w-112 flex-shrink-0">
            ...
            <div className="grid grid-cols-2 gap-4">
                    ...
                    <div className="space-y-0.5">
                      {category.projects.map((project, projectIndex) => (
                        <a
                          ...
                          target="_blank"
                          rel="noopener noreferrer"
                          className={`group flex items-center gap-1.5 p-2 rounded-md bg-white shadow-sm border border-gray-100 hover:shadow-md transition-all duration-300 hover:scale-[1.01] ${project.color}`}
                        >
                          <div className="flex-1">
                            <h4 className="font-medium text-xs group-hover:underline decoration-2 underline-offset-2">
                              {project.title}
                            </h4>
                          </div>
              ...
              {/* Right Column: Health is Wealth & Consulting */}
              <div className="space-y-3">
